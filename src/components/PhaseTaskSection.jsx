...
function PhaseTaskSection({
    ...
    const handleDragLeave = (e) => {
        // Only clear when truly leaving the section element, not a child
    ...
    return (
        ...
        >
            ...
            >
                ...
                {isDragOver && (
                    <span className="text-xs text-blue-600 font-medium shrink-0">Drop here</span>
                )}
            ...
            {!expanded && isDragOver && (
                <div className="px-3 py-2 text-xs text-blue-500 bg-blue-50/60 text-center">
