...
function InviteAcceptPage() {
  ...
  const autoAcceptInvitation = async (invitationData, user) => {
    ...
    try {
      ...
      addToast('Invitation accepted! Welcome to the organization.', 'success');
      ...
      try {
        ...
        if (signUpError) {
          ...
          if (signUpError.message.includes('already registered') || signUpError.message.includes('User already registered')) {
            setUserExists(true);
            addToast('An account with this email already exists. Please sign in to claim this invitation.', 'info');
            return;
          }
          throw signUpError;
        }
        ...
        // Redirect to dashboard/org page
        addToast('Account created and invitation accepted! Welcome to SiteWeave.', 'success');
        // Reload the page to refresh app context with new organization
        window.location.href = '/';
      } catch (error) {
        console.error('Error accepting invitation:', error);
