...
export default function MessagesView() {
  ...
  if (state.isLoading) {
    return <div className="mt-16"><LoadingSpinner size="lg" text="Loading messages..." /></div>
  }

  return (
    <div className="mx-auto max-w-7xl px-2 sm:px-4 py-4 space-y-4">
      ...
      <div className="h-[calc(100vh-13rem)] app-card overflow-hidden flex">
